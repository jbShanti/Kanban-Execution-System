...
- [/] Implement telemetry engine #Execution [score::89]
...
- [x] Fix metadata typing issues #Python
...
[] Broken checkbox syntax

- [ ]Valid task without space

- [/] Mixed formatting task #Test [score::13] [[Execution Model]]

- [ ] Task with external link [Docs](https://example.com)

- [ ] Task with internal link [[Knowledge Base]]
...
- [ ] Multiline task starts here
  continuation line for multiline task
  another continuation line

    - [ ] Indented task with spaces

- [ ] Duplicate metadata test [score::10] [score::20]

- [ ] Malformed date task @{2026-99-99}
...
- [ ] Task with malformed metadata [priority-high]

- [ ] Task with strange spacing     #AI      [score::30]

- [ ] Task with emoji 🚀 #Launch

- [ ] Task with unicode title — тестирование парсера

- [ ] Task with escaped chars \#notatag

- [ ] Task with mixed links [[Internal]] and [External](https://example.com)